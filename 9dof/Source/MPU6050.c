...
//	IIC_WriteData(addr, 0x6B , &inData[0],1);             //PWR_MGMT_1    -- DEVICE_RESET 1
//    Delay_Ms(5);
...
void MPU6050ReadGyro(int* gyroData)
{
    ...
    if(gyroData[0]&0x8000)
    {
      gyroData[0]=gyroData[0]-65535;
    }
    else
    {
    gyroData[0]=gyroData[0];
        ...
        if(gyroData[1]&0x8000)
    {
      gyroData[1]=gyroData[1]-65535;
    }
    else
    {
    gyroData[1]=gyroData[1];
        ...
        if(gyroData[2]&0x8000)
    {
      gyroData[2]=gyroData[2]-65535;
    }
    else
    {
